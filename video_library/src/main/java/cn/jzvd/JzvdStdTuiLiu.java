 ...
 * On 2016/04/18 16:15
 */
public class JzvdStdTuiLiu extends JzvdTuiLiu {
    ...
    public JzvdStdTuiLiu(Context context) {
        super(context);
    }

    public JzvdStdTuiLiu(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
...
//            clarityPopWindow.update(clarity, -offsetX, -offsetY, Math.round(layout.getMeasuredWidth() * 2), layout.getMeasuredHeight());
    ...
    private ononCompletionListener listener;
