...
public class HtmlTextView extends JellyBeanSpanFixTextView {
    ...
    /**
     * @zbv 本人修改的在setHtml下可以使用span
     */
    public void setHtml(@NonNull String html, @Nullable Html.ImageGetter imageGetter,
                        boolean needFillBlank, HtmlTagHandler.FillBlankInterface fillBlankInterface) {
        final HtmlTagHandler htmlTagHandler = new HtmlTagHandler(getPaint());
        htmlTagHandler.setClickableTableSpan(clickableTableSpan);
        htmlTagHandler.setDrawTableLinkSpan(drawTableLinkSpan);
        htmlTagHandler.setListIndentPx(indent);
        ...
        //新增
        htmlTagHandler.setNeedFillBlank(needFillBlank);
        htmlTagHandler.setFillBlankInterface(fillBlankInterface);
