...
public class HtmlTagHandler implements Html.TagHandler {
     ...
     * 新增是否为填空
     */
    private boolean needFillBlank = false;

    public void setNeedFillBlank(boolean needFillBlank) {
        this.needFillBlank = needFillBlank;
    }
    ...
    public void setFillBlankInterface(FillBlankInterface fillBlankInterface) {
        this.fillBlankInterface = fillBlankInterface;
    }

    /**
     * 填空题接口
     */
    public interface FillBlankInterface {
        void addSpans(Editable output);
    }
        ...
        if (opening) {
            ...
            if (needFillBlank) {
                if (tag.equalsIgnoreCase("html")) {
                    if (fillBlankInterface != null) {
                        fillBlankInterface.addSpans(output);
                    }
                }
            }
