...
//        Easy_U8	 u8H264Pps[36];				/*  ”∆µsps÷°ƒ⁄»› */
    ...
    private static final String LIC_KEY =
            "79393674363536526D343041526452656F53753670654A76636D63755A57467A65575268636E64706269356C59584E3563324E795A57567562476C325A56634D5671442F7065424859585A7062695A4359574A76633246414D6A41784E6B566863336C4559584A33615735555A5746745A57467A65513D3D";
    ...
    public int openStream(int channel, String url, int type, int sendOption, int mediaType, String user, String pwd) throws IllegalStateException{
        _channel = channel;
        _url = url;
        _type = type;
    ...
    private int openStream() {
        ...
        if (mCtx == 0){
           // throw new IllegalStateException();
            ...
            Log.e("zbv", "openStream: "+"初始化失败，KEY不合法" );
        }
