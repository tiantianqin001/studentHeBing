...
public class PaintPopWindows<X extends PaintPopWindows> {
     ...
     * 创建一个局部悬浮窗
     */
    public PaintPopWindows(Activity activity) {
     ...
     * 创建一个全局悬浮窗
     */
    public PaintPopWindows(Application application) {
    ...
    private PaintPopWindows(Context context) {
        mContext = context;
