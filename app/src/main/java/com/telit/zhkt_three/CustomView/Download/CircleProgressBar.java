...
public class CircleProgressBar extends View {
    ...
    private float strokeWidth = getResources().getDimensionPixelSize(R.dimen.x21);
    private float backgroundStrokeWidth = getResources().getDimensionPixelSize(R.dimen.x9);
