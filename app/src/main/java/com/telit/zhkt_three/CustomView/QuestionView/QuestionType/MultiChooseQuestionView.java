 ...
 * todo 提交后需要删除对应的保存记录
 */
public class MultiChooseQuestionView extends RelativeLayout implements View.OnClickListener {
    ...
    public MultiChooseQuestionView(Context context) {
        this(context, null);
    }

    public MultiChooseQuestionView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public MultiChooseQuestionView(Context context, AttributeSet attrs, int defStyleAttr) {
