 ...
 * todo 提交后需要删除对应的保存记录
 */
public class LinkedLineQuestionView extends RelativeLayout implements View.OnClickListener {
    ...
    public LinkedLineQuestionView(Context context) {
        this(context, null);
    }

    public LinkedLineQuestionView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public LinkedLineQuestionView(Context context, AttributeSet attrs, int defStyleAttr) {
