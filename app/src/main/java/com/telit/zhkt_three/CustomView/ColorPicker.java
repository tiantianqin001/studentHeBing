...
public class ColorPicker extends View {
    ...
    public void setTouchCirclePosition(int x, int y) {
        touchCircleX = x;
        touchCircleY = y;
    }
    ...
    private void init(Context context) {
        ...
        DefaultSize = getResources().getDimensionPixelSize(R.dimen.x240);
...
//        int defaultDimension = dip2px(200);
        int defaultDimension = DefaultSize;
...
//                    colorHSV[2] = Math.max(0f, Math.min(1f, (float) (d / radius)));
                    if (onSeekColorListener != null) {
                        touchCircleY = y;
                        touchCircleX = x;
                        onSeekColorListener.onSeekColorListener(getColor());
                        onSeekColorListener.curMarkPosition(touchCircleX, touchCircleY);
                        postInvalidate();
                    }
                }
    ...
    public interface OnSeekColorListener {
        ...
        void curMarkPosition(int x, int y);
    }
