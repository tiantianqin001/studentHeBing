...
import com.telit.zhkt_three.CustomView.QuestionView.JudgeSelectToShowView;
 ...
 * todo 提交后需要删除对应的保存记录
 */
public class SingleChooseQuestionView extends RelativeLayout implements View.OnClickListener {
    ...
    public SingleChooseQuestionView(Context context) {
        this(context, null);
    }

    public SingleChooseQuestionView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public SingleChooseQuestionView(Context context, AttributeSet attrs, int defStyleAttr) {
