 ...
 * todo 提交后需要删除对应的保存记录
 */
public class JudgeItemQuestionView extends RelativeLayout implements View.OnClickListener {
    ...
    public JudgeItemQuestionView(Context context) {
        this(context, null);
    }

    public JudgeItemQuestionView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public JudgeItemQuestionView(Context context, AttributeSet attrs, int defStyleAttr) {
