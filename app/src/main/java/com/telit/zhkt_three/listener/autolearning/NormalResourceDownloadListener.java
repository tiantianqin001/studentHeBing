 ...
 * ******************************************************************
 */
public class NormalResourceDownloadListener extends DownloadListener {
    AutoLearningAdapter.RVAutoLearningNormalResourceViewHolder viewHolder;

    public NormalResourceDownloadListener(Object tag, AutoLearningAdapter.RVAutoLearningNormalResourceViewHolder viewHolder) {
        super(tag);
    ...
    public void onError(Progress progress) {
        ...
        QZXTools.logE("exception:"+throwable.getMessage(),null);
    }
    ...
    public void onFinish(File file, Progress progress) {
        ...
        QZXTools.logE("onFinish path:"+file.getPath(),null);
    }
