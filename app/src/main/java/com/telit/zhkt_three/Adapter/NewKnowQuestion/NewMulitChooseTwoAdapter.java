...
public class NewMulitChooseTwoAdapter extends RecyclerView.Adapter<NewMulitChooseTwoAdapter.ViewHolder> {
    ...
    public NewMulitChooseTwoAdapter(Context mContext, QuestionBank questionBank, String status) {
